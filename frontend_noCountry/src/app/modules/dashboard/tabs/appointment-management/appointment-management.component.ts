...
import { debounceTime, distinctUntilChanged, filter, of, Subject, Subscription } from 'rxjs';
import { CommonModule } from '@angular/common';
import { AppointmentService } from '../../../../core/services/appointment/appointment.service';
import { AuthCurrentUser } from '../../../../core/models/auth';
import { AuthService } from '../../../../core/auth/auth.service';
import { AppointmentDetailResponse } from '../../../../core/models/appointment';
...
export class AppointmentManagementComponent {
  appointments: AppointmentDetailResponse[] | null = null;
  ...
  constructor(private fb: FormBuilder, private appointmentService: AppointmentService, private authService: AuthService) {
    ...
    this.searchSub = this.search$.pipe(
      ...
      next: (response: any) => {
        this.appointments = (response?.body?.appointments as AppointmentDetailResponse[]) ?? [];
  ...
  async getAppointments() {
    this.appointmentService.getAllAppointmentsByPatient(this.user!.data!.id).subscribe({
      next: (response: any) => {
        console.log(response);
        this.appointments = response.appointments as AppointmentDetailResponse[];
